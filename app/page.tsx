...
export default function Home() {
  return (
    <div className="flex flex-col min-h-screen">
            ...
            <div className="flex flex-col justify-center space-y-4">
              <div className="space-y-2">
                ...
                <p className="max-w-[600px] text-gray-500 md:text-xl dark:text-gray-400">
                  Build a stunning portfolio with Ekspresi. Showcase your work
                  with customizable grid layouts and track your audience
                  engagement.
                </p>
              </div>
          ...
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="space-y-2">
              ...
              <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                Ekspresi provides all the tools you need to create a
                professional photography portfolio that stands out.
              </p>
            </div>
          </div>
          <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3 mt-12">
            <div className="flex flex-col items-center space-y-2 rounded-lg border p-6 shadow-sm">
              ...
              <p className="text-center text-muted-foreground">
                Create beautiful photo layouts with customizable grid settings
                for each collection.
              </p>
            </div>
            <div className="flex flex-col items-center space-y-2 rounded-lg border p-6 shadow-sm">
              ...
              <p className="text-center text-muted-foreground">
                Track who views your portfolio with detailed analytics and
                visitor insights.
              </p>
            </div>
            <div className="flex flex-col items-center space-y-2 rounded-lg border p-6 shadow-sm">
              ...
              <p className="text-center text-muted-foreground">
                Organize your work into collections with custom settings for
                each group.
              </p>
            </div>
            <div className="flex flex-col items-center space-y-2 rounded-lg border p-6 shadow-sm">
            ...
            <div className="flex flex-col items-center space-y-2 rounded-lg border p-6 shadow-sm">
              ...
              <p className="text-center text-muted-foreground">
                Connect your own domain or use our free subdomain for your
                portfolio.
              </p>
            </div>
            <div className="flex flex-col items-center space-y-2 rounded-lg border p-6 shadow-sm">
      ...
      <section
        id="showcase"
        className="w-full py-12 md:py-24 lg:py-32 border-y"
      >
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="space-y-2">
              ...
              <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                Create stunning photo layouts with our flexible grid system.
                Adjust columns, spacing, and more.
              </p>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground">
                  Each photo collection can have its own unique grid layout.
                  Adjust columns, spacing, rounded corners, and captions for
        ...
        <div className="container px-4 md:px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            ...
            <div className="order-1 md:order-2 space-y-4">
              ...
              <p className="text-muted-foreground">
                Track who views your portfolio with our comprehensive analytics
                dashboard. Understand your audience and optimize your content.
              </p>
              <ul className="space-y-2">
                <li className="flex items-center">
                  <div className="mr-2 h-4 w-4 rounded-full bg-primary"></div>
        ...
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="space-y-2">
              ...
              <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl">
                Photographers Love Ekspresi
              </h2>
              <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                See what professional photographers are saying about our
                platform.
              </p>
            </div>
          </div>
          <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3 mt-12">
            <div className="flex flex-col justify-between space-y-4 rounded-lg border p-6 shadow-sm">
              <div className="space-y-2">
                ...
                <p className="text-muted-foreground">
                  "Ekspresi has transformed how I showcase my work. The
                  customizable grids and analytics have helped me understand
            ...
            <div className="flex flex-col justify-between space-y-4 rounded-lg border p-6 shadow-sm">
              <div className="space-y-2">
                ...
                <p className="text-muted-foreground">
                  "The ability to create different grid layouts for each photo
                  group is exactly what I needed. My portfolio has never looked
                  better."
                </p>
              </div>
              <div className="flex items-center gap-4">
            ...
            <div className="flex flex-col justify-between space-y-4 rounded-lg border p-6 shadow-sm">
              <div className="space-y-2">
                ...
                <p className="text-muted-foreground">
                  "I've tried many portfolio platforms, but Ekspresi stands out
                  with its analytics. I can finally see who's viewing my work
                  and for how long."
                </p>
              </div>
              <div className="flex items-center gap-4">
          ...
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="space-y-2">
              ...
              <p className="max-w-[600px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                Join thousands of photographers who trust Ekspresi to display
                their portfolios.
              </p>
            </div>
            <div className="flex flex-col gap-2 min-[400px]:flex-row">
      ...
      <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t">
        <p className="text-xs text-gray-500 dark:text-gray-400">
          © 2025 Ekspresi. All rights reserved.
        </p>
